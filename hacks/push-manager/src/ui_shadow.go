...
// storePanelIdx is the index of the StorePanel within shadowUI.panels.
const storePanelIdx = 4
...
func shadowUIHandleCC(cc, val uint8) {
	...
	if val == 127 {
		...
		case CCScreenTop4: // Browse
			...
			return
		case CCScreenTop5: // Store
			shadowUI.panelIdx = storePanelIdx
			panel4 := shadowUI.panels[storePanelIdx]
			shadowUI.mu.Unlock()
